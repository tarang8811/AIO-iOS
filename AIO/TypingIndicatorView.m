...
- (void)configureSubviews
{
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:|-5-[thumbnailView]-10-[titleLabel]-8-[timeLabel()]-(>=0)-|" options:0 metrics:metrics views:views]];
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"H:[titleLabel]-8-[timeLabel]-(>=0)-|" options:NSLayoutFormatAlignAllBottom metrics:metrics views:views]];
...
- (UILabel *)titleLabel
{
    if (!_titleLabel) {
        ...
        _titleLabel.font = [UIFont fontWithName:@"Lato-Heavy" size:13.0];
...
- (UILabel *)timeLabel
{
    if (!_timeLabel) {
        ...
        _timeLabel.contentMode = UIViewContentModeTopLeft;
        
        _timeLabel.font = [UIFont fontWithName:@"Lato-Heavy" size:12.0];
...
- (void)presentIndicatorWithName:(NSString *)name image:(UIImage *)image
{
    ...
    [attributedString addAttributes:@{NSFontAttributeName: [UIFont fontWithName:@"Lato-Heavy" size:13.0]} range:[text rangeOfString:name]];

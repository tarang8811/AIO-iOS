...
//MARK: Vars used for Chat functionality
    ...
    func commonInit() {
        ...
        NotificationCenter.default.addObserver(self,  selector: #selector(ChatViewController.textInputbarDidMove(_:)), name: NSNotification.Name.SLKTextInputbarDidMove, object: nil)
    }
...
//        self.configureActionItems()
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        print("TextView shown : \(self.textView.isHidden)")
...
//        
//        let arrowItem = UIBarButtonItem(image: UIImage(named: "icn_arrow_down"), style: .plain, target: self, action: #selector(ChatViewController.hideOrShowTextInputbar(_:)))
//        let editItem = UIBarButtonItem(image: UIImage(named: "icn_editing"), style: .plain, target: self, action: #selector(ChatViewController.editRandomMessage(_:)))
//        let typeItem = UIBarButtonItem(image: UIImage(named: "icn_typing"), style: .plain, target: self, action: #selector(ChatViewController.simulateUserTyping(_:)))
//        let appendItem = UIBarButtonItem(image: UIImage(named: "icn_append"), style: .plain, target: self, action: #selector(ChatViewController.fillWithText(_:)))
//        let pipItem = UIBarButtonItem(image: UIImage(named: "icn_pic"), style: .plain, target: self, action: #selector(ChatViewController.togglePIPWindow(_:)))
...
extension ChatViewController {
    ...
    override func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
        ...
        if tableView == self.tableView {
            ...
            let attributes = [
                NSFontAttributeName : UIFont(name: Constants.fontNameForLeftMenuTableViewCellLabels, size: pointSize),
